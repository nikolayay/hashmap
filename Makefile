CC=gcc
COMMON= -g3 -Wall -Wextra -Wfloat-equal -pedantic -std=c90 -Wpointer-arith
DEBUG= -g3
...
testrealloc : assoc.h testassoc.c specific.h realloc.c general.h general.c
	$(CC) realloc.c testassoc.c general.c -o testrealloc -I./Realloc $(PRODUCTION) $(LDLIBS) && ./testrealloc
